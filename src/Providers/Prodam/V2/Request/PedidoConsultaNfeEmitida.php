...
class PedidoConsultaNfeEmitida implements IRequest
{
    ...
    private $action = 'ConsultaNFeEmitidas';
    ...
    /**
     * PedidoConsultaNfeEmitida constructor.
     */
    ...
    public function setDataInicio($dataInicio)
    {
        try{
            ...
            if ($date == null){
                throw new \Exception('A data de inicio é nula ou não está no formato YYYY-MM-DD. Valor informado: '. $dataInicio);
            }
    ...
    public function getEnvelopString(){
        ...
        return '<ConsultaNFeEmitidasRequest xmlns="http://www.prefeitura.sp.gov.br/nfe">
