...
/**
 * Se não existir erros e a NFS-e for gerada com sucesso,
 * o array $listaNfse conterá os dados das notas fiscais geradas
 *
 * Class PedidoGerarNfseResponse
 * @package Nfsews\Providers\Procempa\V3\Response
 */
class PedidoGerarNfseResponse extends Response
{
    public $listaNfse = [];
    ...
    public function parseXml($xml){
        ...
        if (stripos($xml, 'GerarNfseResposta') === false){
