...
/**
 * Class PedidoConsultarSituacaoLoteRps
 *
 * Utilizado para consulta a situação de um Lote de RPS Enviado e saber se o mesmo já se encontra processado
 *
 * @package Nfsews\Providers\Procempa\V3\Request
 */
class PedidoConsultarSituacaoLoteRps implements IRequest
{

    const SYS_DS = DIRECTORY_SEPARATOR;
    private $abrasfVersion = '1.00';
    private $soapHelper = '\\Nfsews\\Providers\\Procempa\\V3\\Helpers\\Soap';
    private $responseNamespace = '\\Nfsews\\Providers\\Procempa\\V3\\Response\\PedidoConsultarSituacaoLoteRpsResponse';
    private $templatePath = null;
    private $action = 'ConsultarSituacaoLoteRps';
    ...
    {
        $this->templatePath = __dir__ . self::SYS_DS . '..' . self::SYS_DS . 'template' . self::SYS_DS . 'PedidoConsultarSituacaoLoteRps.xml'  ;
    }
    ...
    public function getEnvelopString(){
        ...
        return '<ns2:ConsultarSituacaoLoteRpsRequest xmlns:ns2="http://ws.bhiss.pbh.gov.br">
